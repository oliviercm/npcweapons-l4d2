...
SWEP.ReloadSounds				= {{0.8, "swep_ai_l4d2_shotgun_reload_1"}, {1.6, "swep_ai_l4d2_shotgun_reload_2"}}
...
SWEP.Primary.Sound				= "swep_ai_l4d2_shotgun_fire"
SWEP.Primary.ExtraSounds		= {{0.4, "swep_ai_l4d2_shotgun_reload_2"}}
