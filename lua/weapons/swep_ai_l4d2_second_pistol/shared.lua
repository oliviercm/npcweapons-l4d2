...
SWEP.ReloadSounds				= {{0.4, "swep_ai_l4d2_second_pistol_reload_1"}, {1.0, "swep_ai_l4d2_second_pistol_reload_2"}, {1.6, "swep_ai_l4d2_second_pistol_reload_3"}}
...
SWEP.Primary.Sound				= "swep_ai_l4d2_second_pistol_fire"
